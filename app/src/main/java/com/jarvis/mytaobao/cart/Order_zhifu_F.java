...
public class Order_zhifu_F extends Fragment implements IBtnCallListener, onCheckedChanged, OnClickListener {
	...
	public Order_zhifu_F(String del) {
		str_del = del;
	}

	public Order_zhifu_F() {
	}
